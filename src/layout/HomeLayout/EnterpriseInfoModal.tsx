...
export const EnterpriseInfoModal: FC<EnterpriseInfoModalProps> = ({ isOpen, onClose, info }) => {
    ...
    const infoItems = [
        ...
        { icon: FaDatabase, label: "Infobase", value: info.infobase },
        { icon: FaShieldAlt, label: "ITS", value: info.its },
    ];

    return (
        <>
            <div className="fixed inset-0" style={{ WebkitAppRegion: 'no-drag' } as React.CSSProperties} />
            <div 
                ref={modalRef}
